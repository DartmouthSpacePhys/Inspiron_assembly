...
bridge_data:
	...
	stm		#(acq_seq_out+acq_seq_atx+lsb_sel), AR0
	portw	AR0, wr_disc
...
abu_fill_start:
	...
	stl		A, *AR4+
	ld		@major_count, A				; byte 2, major frame number
	stl		A, *AR4+
...
static_header:
	.string	"Dartmouth College Rx-DSP, AGO Site 2 Unit 0."
