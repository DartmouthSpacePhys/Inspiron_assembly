...
; 11 May 2012	1.00: Reformat monitor as a callable function for pre-compiling
;			into an object file.
...
; Older revision history redacted
; 
...
nbits   .set    8 
nstop   .set    2 
fullbit .set    4167		; Number of CLKOUT cycles/bit at 9600 baud, 
...
;	bc	appcode,TC	; Run app if low, monitor if high 

;
; Monitor code entry point
;
monitor_entry:
...
mon_main:
	...
	stlm	A,AR7
	sub		#0058h,A,A		; X... Exit monitor (return to appcode)?
	bc		ago_main,AEQ
	ldm AR7,A
