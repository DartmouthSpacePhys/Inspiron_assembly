...
ad6620_soft_reset	.uword	0x0000, 0x0100	; Soft Reset (same for M & S)
ad6620_master_run	.uword	0x0000, 0x0800	; Run: end of soft reset, Master
ad6620_slave_run	.uword	0x0000, 0x0000	; Run: end of soft reset, Slave
