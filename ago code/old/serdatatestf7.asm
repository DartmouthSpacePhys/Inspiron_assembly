...
rx_read_loop:
	...
	bc		fifo_empty, NTC				; execute two instructions conditionally
...
buff_clear_loop
	...
	stl		A, *AR5+	; save to serial buffer
...
;	bitf	IFR, #int_bx
;	bc		pre_sleep, TC	; stray interrupt, go back to IDLE
