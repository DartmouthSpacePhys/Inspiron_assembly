...
unit_designation	.uword		2	; Unit number (Master = 0)
code_version		.string		"v0.1"
station_code		.string		"SS"

band_width			.string		"750K"
...
cfreq_table:
		.long	0x01d2f1c9	;  475 KHz
		.long	0x04b439a7	; 1225 KHz
		.long	0x07958185	; 1975 KHz
		.long	0x0a76c964	; 2725 KHz
cfreq_table_end:
...
; write to the second half of the serial buffer
	...
	bc		boot_delay_skip, NTC
	
	; boot lag: if Master (unit 0), insert >10 ms delay 
	; to allow slaves plenty of time to boot up
	rpt	#65535
	nop
	rpt	#65535
	nop
