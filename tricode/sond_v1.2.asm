...
cfreq_toggle1	.set	0x0999	; 2500 kHz
cfreq_toggle2	.set 	0x9A3B
...
bridge_data:
	...
	stm		#(lsb_sel), AR0 ; send acq_seq, set lsb_sel
	portw	AR0, wr_disc
...
dinner_is_ready:
	...
	; note cfreq_walk uses A, B, and AR0, so we need to save B before calling here
